module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      my_target: {
        src: ['css/styles.css', 'sounds/*', 'bower_components/buzz/dist/buzz.min.js', 'bower_components/jquery/dist/jquery.min.js', "bower_components/jquery-ui/jquery-ui.min.js", "bower_components/bootstrap3-dialog/dist/css/bootstrap-dialog.min.css", "bower_components/bootstrap/dist/css/bootstrap.min.css", "bower_components/bootstrap3-dialog/dist/js/bootstrap-dialog.min.js", "bower_components/bootstrap/dist/js/bootstrap.min.js", 'index.html'],
        dest: 'dist/'
      }
    },
    removeDir: {
